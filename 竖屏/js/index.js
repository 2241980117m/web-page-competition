window.onload=function(){
	...
	link[0].onclick=function(){
		window.open("../web/1/html/index.html",false)
	}
	link[1].onclick=function(){
	
		window.open("../web/2/index.html",false)
	}
	link[2].onclick=function(){
		window.open("../web/3/index.html",false)
	}
	link[3].onclick=function(){
		window.open("../web/4/index.html",false)
	}
	link[4].onclick=function(){
		window.open("../web/5/index.html",false)
	}
